...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_testclock_selfcheck_beh_testbench_arch(const char*);
        topvh = createWork_testclock_selfcheck_beh_testbench_arch("Testclock_selfcheck_beh");
